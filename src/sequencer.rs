    ...
    (
        ...
        .lock(|tracks, current_track, recording_cursor, recording_mode| {
            ...
            if cx.local.keyboard.key_event.function == Some(FunctionKey::FN1)
                && cx.local.keyboard.key_event.modifier == Some(ModifierKey::SHIFT)
            {
            ...
            if cx.local.keyboard.key_event.function == Some(FunctionKey::FN1)
                && cx.local.keyboard.key_event.nav == Some(NavKey::FORWARD)
            {
            ...
            // select next track
            if cx.local.keyboard.key_event.modifier == Some(ModifierKey::SHIFT)
                && cx.local.keyboard.key_event.nav == Some(NavKey::FORWARD)
            {
            ...
            if cx.local.keyboard.key_event.function == Some(FunctionKey::FN2)
                && cx.local.keyboard.key_event.modifier == Some(ModifierKey::SHIFT)
            {
            ...
            if cx.local.keyboard.key_event.modifier == Some(ModifierKey::SHIFT)
                && cx.local.keyboard.key_event.nav == Some(NavKey::BACK)
            {
